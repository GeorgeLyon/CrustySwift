...
pub mod request {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_lhs(self) -> u64 {
      self.reader.get_data_field::<u64>(0)
    }
    #[inline]
    pub fn get_rhs(self) -> u64 {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 47] = [
      ...
      ::capnp::word(98, 48, 209, 238, 50, 228, 48, 201),
      ::capnp::word(14, 0, 0, 0, 1, 0, 2, 0),
      ::capnp::word(244, 220, 176, 115, 245, 10, 20, 185),
    ...
    pub const TYPE_ID: u64 = 0xc930_e432_eed1_3062;
  }
}
...
pub mod response {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_boring_sum(self) -> u64 {
      self.reader.get_data_field::<u64>(0)
    }
    #[inline]
    pub fn get_capnp_sum(self) -> u64 {
      self.reader.get_data_field::<u64>(1)
    }
  }
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_boring_sum(&mut self, value: u64)  {
      self.builder.set_data_field::<u64>(0, value);
    }
    #[inline]
    pub fn get_capnp_sum(self) -> u64 {
    ...
    #[inline]
    pub fn set_capnp_sum(&mut self, value: u64)  {
      self.builder.set_data_field::<u64>(1, value);
    }
  }
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 49] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(82, 35, 152, 93, 172, 205, 165, 152),
      ::capnp::word(14, 0, 0, 0, 1, 0, 2, 0),
      ::capnp::word(244, 220, 176, 115, 245, 10, 20, 185),
      ::capnp::word(0, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(98, 111, 114, 105, 110, 103, 83, 117),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(99, 97, 112, 110, 112, 83, 117, 109),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(9, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub static NONUNION_MEMBERS : &[u16] = &[0,1];
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub const TYPE_ID: u64 = 0x98a5_cdac_5d98_2352;
  }
}
